...
ANSWER_PROMPT = (
    ...
    "5. Если клиент хочет двушку, а в данных только диапазоны площадей типа "
    "«48-58 м²» или «45-55 м²» — укажи прямо: «в данных указаны площади 48-58 м², "
    "это может быть и однушка, и двушка, нужно уточнять у застройщика». "
    "Если в данных явно только студии/однушки, а клиент хочет двушку — "
    "честно скажи: «В этих ЖК двушек не нашлось».\n"
    "6. Если в данных ничего нет по запросу — «Не нашлось, извините»."
)
