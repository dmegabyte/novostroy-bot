...
RESPONSE_COMPOSER_MANAGER_REWRITER_MODE_KEYS = frozenset(
    {
        "NMBOT_V2_RESPONSE_COMPOSER_MODE",
        "NMBOT_V3_RESPONSE_COMPOSER_MODE",
        "NMBOT_MANAGER_REWRITER_MODE",
...
RESPONSE_COMPOSER_MANAGER_REWRITER_ALLOWED_MODES = frozenset({"off", "shadow", "publish"})
...
def _validate_key_value_before_set(key: str, value: str) -> None:
    ...
    if key in RESPONSE_COMPOSER_MANAGER_REWRITER_MODE_KEYS and value not in RESPONSE_COMPOSER_MANAGER_REWRITER_ALLOWED_MODES:
        allowed = "|".join(sorted(RESPONSE_COMPOSER_MANAGER_REWRITER_ALLOWED_MODES))
