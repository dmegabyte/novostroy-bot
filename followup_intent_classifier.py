...
- followup_outcome: null без pending_scenario; при pending_scenario — null или ровно одно значение
   из pending_scenario.allowed_reply_outcomes. Это обязательное поле: без pending_scenario верни null.
   Не придумывай значение. Всегда включай поле, включая значение null.
...
Few-shot examples:
1) user: "подбери двушку до 18 млн у метро" -> {"schema_version":3,"goal":"new_search","viewpoint":"life","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{"hard":{"rooms":2,"max_price":18000000,"metro":true}},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.95}
2) context: есть текущий список; user: "теперь до 15 млн" -> {"schema_version":3,"goal":"refine_search","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{"hard":{"max_price":15000000}},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.95}
3) context: есть текущий список; user: "покажи ещё другие" -> {"schema_version":3,"goal":"expand_search","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.9}
4) context: видны ЖК A, ЖК B, ЖК C; user: "сравни эти ЖК" -> {"schema_version":3,"goal":"compare_current","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.9}
5) context: visible_options содержит exact "ЖК A" и "ЖК B"; user: "сравни ЖК A с ЖК B" -> {"schema_version":3,"goal":"compare_current","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":["ЖК A","ЖК B"],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.92}
6) context: selected_object exact "ЖК A", visible_options содержит exact "ЖК B"; user: "сравни с ЖК B" -> {"schema_version":3,"goal":"compare_current","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":["ЖК A","ЖК B"],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.9}
7) context: видны три варианта; user: "какой лучше" -> {"schema_version":3,"goal":"clarify","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":"Что важнее при выборе: бюджет, локация, срок сдачи или инфраструктура?","confidence":0.72}
8) context: pending clarification после вопроса о лучшем варианте; user: "поближе к паркам" -> {"schema_version":3,"goal":"recommend_current","viewpoint":"family","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":["parks"],"constraints_delta":{"preferences":{"parks":true}},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.88}
9) context: видны ЖК A и ЖК B; user: "что по ЖК Дюна?" -> {"schema_version":3,"goal":"lookup_object","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":"ЖК Дюна","comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.9}
10) context: visible_options содержит exact "Мичуринский парк"; user: "мич парк подробнее" -> {"schema_version":3,"goal":"answer_selected","viewpoint":"unchanged","selected_option_name":"Мичуринский парк","named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.86}
11) context: Ирина спросила, позвать оператора? user: "да, позови менеджера" -> {"schema_version":3,"goal":"operator","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":true,"explicit_operator_request":true,"followup_outcome":null,"clarification":null,"confidence":0.95}
12) context: Ирина спросила, позвать оператора? user: "нет, без звонка" -> {"schema_version":3,"goal":"operator","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":false,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.9}
13) context: pending contact_name; user: "вернёмся к заявке" -> {"schema_version":3,"goal":"resume_pending","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.92}
14) context: подбор квартир; user: "а ипотека там есть?" -> {"schema_version":3,"goal":"answer_current","viewpoint":"financing","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":["mortgage_terms"],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.85}
15) user: "расскажи рецепт борща" -> {"schema_version":3,"goal":"off_topic","viewpoint":"unchanged","selected_option_name":null,"named_object_reference":null,"comparison_option_names":[],"requested_facts":[],"constraints_delta":{},"operator_consent":null,"explicit_operator_request":false,"followup_outcome":null,"clarification":null,"confidence":0.95}
""".strip()
...
INTENT_PLAN_V3_JSON_SCHEMA = {
    ...
    "properties": {
        ...
        "followup_outcome": {"type": ["string", "null"], "enum": ["accept", "decline", "ask_or_clarify", "unexpected", "resume_contact", None]},
...
# Catalog boundary: the service lists only Moscow/MO new builds. Ordinal
# wording such as "второй вариант" is deliberately outside this vocabulary.
_SECONDARY_HOUSING_RE = re.compile(
    r"(?<![а-яё])(?:вторичн[а-яё]*|вторичк[а-яё]*|"
    r"(?:квартир[а-яё]*|жиль[её]|дом[а-яё]*)\s+с\s+рук)(?![а-яё])",
    re.IGNORECASE,
)


def secondary_housing_catalog_boundary(user_text: Any) -> dict[str, Any] | None:
    """Return a deterministic semantic boundary plan for clear resale requests."""

    text = " ".join(str(user_text or "").casefold().replace("ё", "е").split())
    if not text or not _SECONDARY_HOUSING_RE.search(text):
        return None
    return {
        "user_goal": "secondary housing is outside the new-build catalog",
        "refers_to_existing_objects": False,
        "requests_new_objects": False,
        "domain_relation": "off_topic",
        "constraints_delta": _empty_constraints(),
        "requested_facts": [],
        "facts_needed": [],
        "requires_enrichment": False,
        "focus_action": "keep",
        "confidence": 1.0,
        "reason": "secondary_housing_outside_catalog",
    }
...
async def plan_dialog_state(
    ...
    *,
    ...
    """
    boundary_plan = secondary_housing_catalog_boundary(user_text)
    if boundary_plan is not None:
        return _with_canonical_fields(
            {"fallback_used": False},
            boundary_plan,
...
_DEICTIC_COMPARISON_RE = re.compile(r"\bсравни(?:ть)?\s+(?:их|этих|обоих|обеих)\b", re.IGNORECASE)
_SELECTED_FINANCING_RE = re.compile(r"\b(?:ипотек\w*|ипотеч\w*)\b", re.IGNORECASE)
_EXPLICIT_ALL_CURRENT_RE = re.compile(
    r"\b(?:все|всё|кажд\w*|оба|обе)\b|\bпо\s+всем\b|\bпо\s+(?:ним|этим)\b",
    re.IGNORECASE,
)
_CLEAR_PENDING_ACCEPT_REPLIES = {"да", "ага", "угу", "конечно", "подтверждаю", "согласен", "согласна"}
_CLEAR_PENDING_DECLINE_REPLIES = {"нет", "не надо", "не нужно", "не хочу", "отказываюсь"}


def _pending_reply_intent_plan_v3(
    user_text: str,
    *,
    pending_scenario: dict[str, Any] | None,
    allowed_facts: list[str] | None,
) -> dict[str, Any] | None:
    """Resolve only closed-set, unambiguous replies from the pending envelope.

    This derives no provider or MCP command. Mixed replies and malformed
    envelopes fall through to the model instead of changing a pending flow.
    """
    pending = pending_scenario if isinstance(pending_scenario, dict) else None
    if not pending:
        return None
    outcomes = pending.get("allowed_reply_outcomes")
    if not isinstance(outcomes, list) or not outcomes:
        return None
    allowed_outcomes = {str(item).strip() for item in outcomes if str(item or "").strip()}
    text = " ".join(str(user_text or "").casefold().replace("ё", "е").split())
    outcome = "accept" if text in _CLEAR_PENDING_ACCEPT_REPLIES else "decline" if text in _CLEAR_PENDING_DECLINE_REPLIES else None
    if outcome is None or outcome not in allowed_outcomes:
        return None
    context = pending.get("context") if isinstance(pending.get("context"), dict) else None
    if context is None:
        return None
    scope = str(context.get("scope") or "").strip()
    goals_by_scope = context.get("goals_by_scope")
    if scope not in {"one", "all"} or not isinstance(goals_by_scope, dict):
        return None
    goal = str(goals_by_scope.get(scope) or "").strip()
    if goal not in {"answer_selected", "answer_current"}:
        return None
    viewpoint = str(context.get("viewpoint") or "unchanged").strip()
    if viewpoint not in {"family", "life", "rental", "investment", "financing", "unchanged"}:
        return None
    selected = str(context.get("selected_option_name") or "").strip()
    if scope == "one" and not selected:
        return None
    raw_facts = context.get("requested_facts", [])
    if not isinstance(raw_facts, list) or any(not isinstance(fact, str) or not fact.strip() for fact in raw_facts):
        return None
    facts = list(dict.fromkeys(fact.strip() for fact in raw_facts))
    allowed_fact_set = {str(fact).strip() for fact in (allowed_facts or AVAILABLE_FACT_FIELDS) if str(fact or "").strip()}
    if any(fact not in allowed_fact_set for fact in facts):
        return None
    return {
        "schema_version": 3,
        "goal": goal,
        "viewpoint": viewpoint,
        "selected_option_name": selected or None,
        "named_object_reference": None,
        "comparison_option_names": [],
...
def _normalize_v3_deictic_comparison_scope(user_text: str, data: dict[str, Any], state: dict[str, Any] | None) -> dict[str, Any]:
    """Give an immediate «сравни их» its already declared exact pair.

    The model may still classify broad comparisons.  It must not decide the
    pronoun scope when a successful explicit pair is the sole persisted scope.
    """
    if not _DEICTIC_COMPARISON_RE.search(str(user_text or "").replace("ё", "е")):
        return data
    current = data.get("comparison_option_names")
    if current not in (None, [], ()):
        return data
    source = state if isinstance(state, dict) else {}
    raw_pair = source.get("comparison_scope_option_names")
    if not isinstance(raw_pair, (list, tuple)) or len(raw_pair) != 2:
        return data
    pair = tuple(str(name).strip() for name in raw_pair)
    if not all(pair) or pair[0] == pair[1]:
        return data
    visible = source.get("visible_options")
    ...
    if not set(pair).issubset(visible_names):
        return data
    normalized = dict(data)
    normalized.update({
        ...
        "selected_option_name": None,
        "named_object_reference": None,
        "comparison_option_names": list(pair),
    })
    normalized["planner_adjustments"] = [*normalized.get("planner_adjustments", []), "deictic_comparison_scope"]
    return normalized


def _selected_financing_intent_plan_v3(
    user_text: str,
    *,
    ...
    """Resolve an unambiguous mortgage question about the selected ЖК locally."""
    text = str(user_text or "").replace("ё", "е")
    if not _SELECTED_FINANCING_RE.search(text) or _EXPLICIT_ALL_CURRENT_RE.search(text):
        return None
    pending = pending_scenario if isinstance(pending_scenario, dict) else {}
    if pending:
        return None

    source = state if isinstance(state, dict) else {}
    selected_context = selected_object if isinstance(selected_object, dict) else {}
    candidates = (
        selected_context.get("canonical_name"),
        selected_context.get("name"),
        (source.get("selected_object") or {}).get("canonical_name") if isinstance(source.get("selected_object"), dict) else None,
        (source.get("selected_object") or {}).get("name") if isinstance(source.get("selected_object"), dict) else None,
        (source.get("selected_option") or {}).get("name") if isinstance(source.get("selected_option"), dict) else None,
        source.get("selected_option_name"),
    )
    names = {str(value).strip() for value in candidates if str(value or "").strip()}
    if len(names) != 1:
        return None
    selected_name = names.pop()
    return {
        "schema_version": 3,
...
async def plan_intent_v3(
    ...
    *,
    ...
    """
    if secondary_housing_catalog_boundary(user_text) is not None:
        return {
            "schema_version": 3,
            "goal": "off_topic",
            "viewpoint": "unchanged",
    ...
    pending_reply = _pending_reply_intent_plan_v3(
        user_text,
    ...
    selected_financing = _selected_financing_intent_plan_v3(
        user_text,
        state=state,
    ...
    try:
        ...
        while time.monotonic() - start < timeout:
            ...
            if status in {"completed", "failed", "cancelled"}:
                ...
                data = _normalize_v3_deictic_comparison_scope(user_text, data, state)
