#!/usr/bin/env python3
"""Score Qapairs context acceptance predictions against locked labels."""
...
DEFAULT_PREDICTIONS = Path("/tmp/opencode/qapairs_context_acceptance_predictions_v1.json")
DEFAULT_LABELS = PROJECT_ROOT / "tests" / "fixtures" / "qapairs_context_acceptance_labels_v1.json"
DEFAULT_OUTPUT = Path("/tmp/opencode/qapairs_context_acceptance_score_v1.json")
DEFAULT_REPORT = Path("/tmp/opencode/qapairs_context_acceptance_report_v1.md")
MAX_SOURCES = 2
MAX_LINES = 80
MAX_CHARS = 8000
