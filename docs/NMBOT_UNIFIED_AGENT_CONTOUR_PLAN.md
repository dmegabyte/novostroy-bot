...
Дата: 2026-08-07
Статус: historical plan; V5 candidate contour removed; production этим документом не изменён
Первый кандидат для пилота: V5 поверх существующего V2 engine (исторически, больше не поддерживается)
