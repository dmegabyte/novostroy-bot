...
class OutcomeTransition:
    ...
    missing_pending_action_transition: "OutcomeTransition | None" = None
...
REPLY_CONTRACTS: dict[str, ReplyContractSpec] = {
    ...
    FINANCING_CONSENT_FOLLOWUP: ReplyContractSpec(
        ...
        planner_context={
            ...
            "scope_policy": "selected_or_current",
        ...
        outcome_transitions={
            "accept": OutcomeTransition(
                Stage.SELECTED_OBJECT,
                TurnAction.ANSWER_SELECTED_OPTION,
                "selected_financing",
                clear_pending=False,
                requires_pending_action=True,
                missing_pending_action_transition=OutcomeTransition(
                    Stage.OPERATOR_HANDOFF, TurnAction.ACCEPT_OPERATOR, "operator_handoff_phone_capture"
                ),
            ),
    ...
    SELECTED_LIVE_FACT_CONSENT_FOLLOWUP: ReplyContractSpec(
        ...
        allowed_outcomes=("accept", "decline", "ask_or_clarify", "unexpected"),
        planner_context={
            "offered_action": "verify_selected_live_facts",
            "scope_policy": "selected_required",
            "goals_by_scope": {"one": "answer_selected"},
            "viewpoint": "unchanged",
            "requested_facts_policy": "dialog_focus",
        },
        outcome_transitions={
